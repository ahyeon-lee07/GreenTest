...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "WUxGoLkwuEwhRFm0MLmC";
	private final static String CLIENT_SECRET = "F7blp1Is6p";
	private final static String REDIRECT_URI = "http://localhost:8080/green/snsJoin/callback";
