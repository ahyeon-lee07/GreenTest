...
public class BoardControllerImpl implements BoardController {
	 ...
	 * String notice(Locale locale, Model model) { return "notice"; }
	 * 
	 * //공지사항상세
	 * 
	 * @RequestMapping(value = "/notice_in.do", method = RequestMethod.GET) public
	 * String notice_in(Locale locale, Model model) { return "notice_in"; }
	 */
	@Override
	...
	public ModelAndView notice(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<ArticleVO> notice = boardService.notice();
	 ...
	 * " location.href='"+request.getContextPath()+"/notice/notice.do';"; message
	 ...
	 * private ModelAndView form(HttpServletRequest request, HttpServletResponse
