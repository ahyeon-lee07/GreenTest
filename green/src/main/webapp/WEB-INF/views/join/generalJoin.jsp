			...
			<div class="col-12">
				<form action="${contextPath}/member/addMember.do" method="POST">
						...
						<div class="col p-0">
							<div class="d-flex bd-highlight">
								<label for="inputId" class="bd-highlight col-form-label pl-2"
									style="width: 140px;"><img src="${contextPath }/resources/img/require.png">아이디</label>
								<div class="flex-grow bd-highlight pr-2">
									<input type="text" class="form-control" id="inputId" name="id">
								</div>
								<button class="btn btn-success btn-sm" onclick="id_checkform()">중복 확인</button>
								&nbsp;&nbsp;
								<span id="idMsg"></span> (영문 소문자/숫자, 4~16자)
							</div>
						</div>
					</div>
					<div class="row border-bottom py-2">
						<div class="col p-0">
							<div class="d-flex bd-highlight">
								<label for="inputPassword"
									class="bd-highlight col-form-label pl-2" style="width: 140px;"><img src="${contextPath }/resources/img/require.png">비밀번호</label>
								<div class="flex-grow bd-highlight pr-2">
									<input type="password" class="form-control" id="Password" name="pw">
								</div>
								<span id="pwMsg"></span> (영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 10자~16자)
							</div>
						</div>
					</div>
					<div class="row border-bottom py-2">
						<div class="col p-0">
							<div class="d-flex bd-highlight">
								<label for="inputPassword"
									class="bd-highlight col-form-label pl-2" style="width: 140px;"><img src="${contextPath }/resources/img/require.png">비밀번호 확인</label>
								<div class="flex-grow bd-highlight pr-2">
						...
						<div class="col p-0">
							<div class="d-flex bd-highlight">
								<label for="inputName" class="bd-highlight col-form-label pl-2"
									style="width: 140px;"><img src="${contextPath }/resources/img/require.png">이름</label>
								<div class="flex-grow bd-highlight pr-2">
					...
					<div class="row border-bottom py-2">
						<div class="col p-0">
							<div class="d-flex bd-highlight">
								...
								<div class="flex-grow bd-highlight pr-2">
									<input type="text" class="form-control" id="inputBirth" name="birth">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col p-0">
							<div class="d-flex bd-highlight">
								<label for="inputUser" class="bd-highlight col-form-label pl-2"
									style="width: 140px;"><img src="${contextPath }/resources/img/require.png">주소</label>
								<div class="flex-grow-1 bd-highlight flex-column pr-2">
									<div class="bd-highlight mb-2">
										<div class="d-flex flex-row bd-highlight">
											<div class="bd-highlight">
												<input type="text" class="form-control"
													id="sample6_postcode" placeholder="우편번호" name="zipCode" readonly>
											</div>
										...
										<div class="d-flex flex-row bd-highlight">
											<div class="bd-highlight">
												<input type="text" class="form-control" id="sample6_address"
													placeholder="주소" style="width: 300px;" name="address1" readonly>
											</div>
										</div>
									</div>
									...
									<div class="bd-highlight mb-2">
										<div class="d-flex bd-highlight">
											<div class="d-flex flex-row">
												...
												<div class="p-2"></div>
												<input type="text" class="form-control"
													id="sample6_extraAddress" placeholder="참고항목"  name="address3" readonly>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col p-0">
							<div class="d-flex bd-highlight">
								<label for="inputNumber" class="bd-highlight col-form-label pl-2"
									style="width: 140px;"><img src="${contextPath }/resources/img/require.png">휴대전화</label>
								<div class="flex-grow bd-highlight pr-2">
					...
					<div class="col mt-4 mb-1 p-0">
						<h6 class="font-weight-bold">약관 동의</h6>
					</div>
					<div class="row">
							...
							<div class="bd-highlight p-2 pl-3 bg-light border-bottom">
								<div class="form-check">
									<input type='checkbox'
       										...
       										<b>모두 동의</b> <label
										class="form-check-label pl-2" for="cb_all">
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
					...
					<div class="text-center">
						<button type="button" class="btn btn-outline-success"
							data-toggle="modal" data-target="#join_membership_2">완료</button>
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<input type="submit" class="btn btn-outline-success" value="확인" onclick="complet_checkform()">
										<button type="button" class="btn btn-outline-success"
...
alert("회원 가입이 완료되었습니다! 감사합니다. 좋은 하루 보내십시오 :)");
}
</script>