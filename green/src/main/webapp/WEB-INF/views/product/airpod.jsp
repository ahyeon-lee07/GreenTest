				...
				<div class="bd-highlight">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb p-0 bg bg-transparent">
							...
							<li class="breadcrumb-item active" aria-current="page">에어팟 케이스</li>
						</ol>
					</nav>
				</div>
			</div>
					...
					<div
						...
						<div class="col mb-5">
							<div class="card h-100">
								...
								<a href="${contextPath}/AirpodCaseDetail.do"><img
									class="card-img-top"
									src="${contextPath }/resources/img/airpod.png" alt="..." /></a>
								<!-- Product details-->
