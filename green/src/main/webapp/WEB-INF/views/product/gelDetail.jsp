				...
				<div class="row gx-4 gx-lg-5 align-items-center">
					<div class="col-md-6">
						<img class="card-img-top mb-5 mb-md-0"
							src="${contextPath}/resources/img/젤_귤따는 귤곰.png" alt="[젤] 귤따는 귤곰" />
					</div>
					<div class="col-md-6">
						<!-- 상품명 -->
						<div class="row">
							<div class="col-md-3">상품명 :</div>
							<div class="col-md-9">[젤] 귤따는 귤곰</div>
						</div>
						<br>
						<!-- 상품가격-->
						<div class="row">
						...
						<div class="d-flex justify-content-around">
							...
							<div class="p-2 bd-highlight">
								<a href="${contextPath}/wist_list.do" class="btn btn-lg btn-outline-success">관심상품</a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="py-5">
		...
		<div class="tab-content" id="nav-tabContent">
			<div class="tab-pane fade show active" id="nav-home" role="tabpanel"
				...
				<br>
				<img hspace="5" vspace="0"
					src="${contextPath }/resources/img/젤_설명.PNG" alt="[젤] 설명">
				<br>
				<img hspace="5" vspace="0"
					src="${contextPath }/resources/img/젤_설명2.PNG" alt="[젤] 설명2">
				<br>
				<img hspace="5" vspace="0"
					src="${contextPath }/resources/img/젤_설명3.PNG" alt="[젤] 설명3">
				<br>
				<img hspace="5" vspace="0"
					src="${contextPath }/resources/img/공통_설명.PNG" alt="[공통] 설명">
			</div>
			...
			<div class="tab-pane fade" id="nav-contact2" role="tabpanel"
				...
				<iframe src="http://localhost:8080/green/product.do" width="90%" name="Q&A" 
				height="90%" frameborder="0" marginheight="0" marginwidth="0" scrolling="auto"></iframe>
			</div>
		</div>
		</div>
