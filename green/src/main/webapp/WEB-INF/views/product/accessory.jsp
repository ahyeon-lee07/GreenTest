				...
				<div class="bd-highlight">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb p-0 bg bg-transparent">
							...
							<li class="breadcrumb-item active" aria-current="page">액세서리</li>
						</ol>
					</nav>
				</div>
			</div>
					...
					<div
						...
						<div class="col mb-5">
							<div class="card h-100">
								...
								<!-- Product image-->
								<a href="${contextPath}/SmartTokDetail.do"><img
									class="card-img-top"
									src="${contextPath }/resources/img/smartTok.png" alt="..." /></a>
								<!-- Product details-->
								<div class="card-body p-4">
									<div class="text-center">
										<!-- Product name-->
