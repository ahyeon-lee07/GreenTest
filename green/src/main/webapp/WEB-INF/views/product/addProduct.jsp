                ...
                <div class="col-12">
                    <form name="joinForm" method="POST">
                        <div class="row border-bottom py-2">
                            <div class="col p-0">
                                <div class="d-flex bd-highlight">
                                    <label for="inputShowYN" class="bd-highlight col-form-label pl-2"
                                        style="width: 140px;">활성화 여부</label>
                                    <div class="d-flex flex-row bd-highlight pr-2">
                                        <div class="custom-control custom-switch pt-2">
                                            <input type="checkbox" class="custom-control-input" id="inputShowYN"
                                                name="showYN" value="N">
                                            <label id="inputShowYNLabel" class="custom-control-label"
                                                for="inputShowYN" style="width: 70px;">비활성화</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-flex bd-highlight">
                                    ...
                                    <div class="flex-grow bd-highlight flex-column pr-2">
                                        <div class="flex-grow-1 bd-highlight pr-2">
                                            <div class="d-flex">
                                                <select id="inputGroup" class="form-control " name="group">
                        ...
                        <div class="row border-bottom py-2">
                            <div class="col p-0">
                                <div class="d-flex bd-highlight">
                                    <label for="inputProductName" class="bd-highlight col-form-label pl-2"
                        ...
                        <div class="row border-bottom py-2">
                            <div class="col p-0">
                                <div class="d-flex bd-highlight">
                                    <label for="inputProductOption" class="bd-highlight col-form-label pl-2"
                                        style="width: 140px;"><img src="${contextPath }/resources/img/require.png">상품
                                        옵션</label>
                                    <div class="flex-grow bd-highlight pr-2 flex-column">
                                        <button id="btn_addOption" type="button" class="btn btn-secondary"
                        ...
                        <div class="row border-bottom py-2">
                            <div class="col p-0">
                                <div class="d-flex bd-highlight">
                                    ...
                                    <div class="d-flex flex-row bd-highlight pr-2">
                                        <input type="number" class="form-control" id="inputPrice" name="price" min="0">
                        ...
                        <div class="row border-bottom py-2">
                            <div class="col p-0">
                                <div class="d-flex bd-highlight">
                                    <label for="inputDiscountYN" class="bd-highlight col-form-label pl-2"
                                        style="width: 140px;">할인 여부</label>
                                    <div class="d-flex flex-row bd-highlight pr-2">
                                        <div class="custom-control custom-switch pt-2">
                                            <input type="checkbox" class="custom-control-input" id="inputDiscountYN"
                                                name="discountYN" value="N">
                                            <label id="discountYNLabel" class="custom-control-label"
                                                for="inputDiscountYN" style="width: 50px;">미할인</label>
                                        </div>
                                        <div class="d-flex flex-row bd-highlight pl-3 pr-2">
                                            <input type="number" class="form-control" id="discountYN_Num"
                                                name="discount" min="0" max="100" style="width: 102px;" disabled> <span
                                                class="bd-highlight pl-2 pt-2">%</span>
                                        </div>
                                        <div class="d-flex flex-row bd-highlight ">
                                            <input type="text" class="form-control text-danger bg-white border-0" id="discount" name="discount" style="width: 200px;" value="" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row border-bottom py-2">
                            <div class="col p-0">
                                <div class="d-flex bd-highlight">
                                    <label for="inputProductMileage" class="bd-highlight col-form-label pl-2"
                                        style="width: 140px;">상품적립금</label>
                                    <div class="d-flex flex-row bd-highlight pr-2">
                                        <input type="number" class="form-control" id="inputProductMileage"
                                            name="productMileage" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row border-bottom py-2">
                            <div class="col p-0">
                                <div class="d-flex bd-highlight">
                                    <label for="inputImgURL_product_M" class="bd-highlight col-form-label pl-2"
                                        style="width: 140px;">상품이미지</label>
                                    <div class="d-flex flex-row bd-highlight pr-2 pt-1">
                                        <input type="file" class="form-control-file" id="inputImgURL_product_M"
                                            name="imgURL_product_M">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row border-bottom py-2">
                            <div class="col p-0">
                                <div class="d-flex bd-highlight">
                                    <label for="inputImgURL_product_S" class="bd-highlight col-form-label pl-2"
                                        style="width: 140px;">상품상세이미지</label>
                                    <div class="d-flex flex-row bd-highlight pr-2 pt-1">
                                        <input type="file" class="form-control-file" id="inputImgURL_product_S"
                                            name="imgURL_product_S">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-3">
                            <button type="submit" class="btn btn-success" onclick="return checkLogin()">등록</button>
                        </div>
                    </form>
                </div>
            </div>
