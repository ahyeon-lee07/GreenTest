										...
										<div class="row py-2 mt-3">
											<div class="d-flex flex-fill justify-content-between">
												...
												<div class="d-highlight">
													...
													<button type="button" class="btn btn-success ml-2">회원정보 수정</button>
												</div>
											</div>
										</div>
									</form>
					...
					<script>
						...
						function checkLogin() {
							...
							if (pwExp == null) {
								...
								form.action = "${contextPath}/member/ad111dMember.do";
								form.submit();
							}
						}
